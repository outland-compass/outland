...
export type Database = {
    ...
    Tables: {
      ...
      search_profiles: {
        Row: {
          ...
          name: string;
          price_ceiling_eur: number | null;
          price_priority_eur: number | null;
          updated_at: string;
        };
        Insert: {
          area_max_m2?: number | null;
      ...
      decisions: {
        Row: {
          ...
          id: string;
          max_price: number | null;
          previous_status: Database['public']['Enums']['candidate_status'] | null;
          reason: string;
          resulting_status: Database['public']['Enums']['candidate_status'] | null;
          target_offer: number | null;
        };
        Insert: {
          candidate_id: string;
    ...
    Views: {
      ...
      v_candidate_radar: {
        Row: {
          ...
          land_price_band: string | null;
          municipality: string | null;
          price_per_m2: number | null;
          recommendation: string | null;
          region: string | null;
          settlement: string | null;
          search_profile_code: string | null;
  ...
  public: {
    ...
    Enums: {
      ...
      dd_status: 'OPEN' | 'IN_PROGRESS' | 'VERIFIED' | 'FAILED' | 'NOT_APPLICABLE';
      decision_type:
        | 'REVIEW'
        | 'SHORTLIST'
        | 'START_DD'
      ...
      score_dimension: 'PLACE' | 'FEASIBILITY' | 'ECONOMICS' | 'OUTLAND' | 'NETWORK';
